...
const App = () => {
    ...
    const menu = [
        ...
        },
        {
            ...
            items: [
                { label: 'Administradores', icon: 'pi pi-fw pi-id-card', to: '/admins' },
                { label: 'Desarrolladores', icon: 'pi pi-fw pi-check-square', to: '/developers' },
        ...
        <div className={wrapperClass} onClick={onWrapperClick}>
            ...
            <div className="layout-main-container">
                <div className="layout-main">
                    ...
                    <Route path="/developers" component={Desarrolladores} />
